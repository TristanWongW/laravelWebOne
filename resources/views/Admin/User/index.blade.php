   ...
   <div class="mws-panel-body no-padding">
    ...
    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      <thead> 
       <tr role="row">
        <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 157px;">用户ID</th>
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd"> 
            ...
            <form action="/adminuser/{{$item->id}}" method="post">
            ...
            <a href="/adminuser/{{$item->id}}}/edit" class="btn btn-info">修改</a>
            <a href="" class="btn btn-block">查看</a>
